...
const AdminDashboard = () => {
  ...
  // --- PALETA DE ALTO CONTRASTE (SOLO 3 ESTADOS PARA ADMIN) ---
  const chartData = [
  ...
  // El total para el gráfico solo debe incluir estos 3 estados
  const totalRelevant = data.confirmadas + data.pendientes + data.rechazadas || 1;
  
  const chartSegments = chartData.map(item => {
    const percentage = (item.value / totalRelevant) * 100;
    const segment = { 
      ...item, 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-200 active:scale-95 whitespace-nowrap"
          >
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {/* Dona de Distribución con Leyenda Estilo Docente */}
          <div className="bg-white rounded-xl shadow-sm border border-blue-200 p-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
              ...
              {/* LEYENDA CON LÍNEA VERTICAL (IGUAL AL DOCENTE) */}
