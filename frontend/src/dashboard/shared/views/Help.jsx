...
const Help = () => {
  ...
  const faqs = {
    reservas: [
      ...
      },
      {
        ...
        respuesta: 'Puedes hacer reservas con hasta 15 días de anticipación.'
      },
      {
        id: 3,
  ...
  return (
    <div className="w-full">
      {/* HEADER (igual que en Inicio/Dashboard/Configuración) */}
      <div className="mb-8">
          ...
          <section className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            <div className="border-b border-slate-100 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-semibold text-slate-900">Preguntas frecuentes</h2>
              </div>
            </div>
          ...
          <section className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            <div className="border-b border-slate-100 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-semibold text-slate-900">Soporte Directo</h2>
              </div>
            </div>
