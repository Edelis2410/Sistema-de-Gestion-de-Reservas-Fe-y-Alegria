...
const Sidebar = ({ isCollapsed, onToggle }) => {
  ...
  // Menú inferior
  const bottomItems = [
    { id: 'settings', label: 'Configuración', icon: <Settings className="h-5 w-5" />, path: '/docente/settings' },
  ...
  return (
    <aside className={`${isCollapsed ? 'w-16' : 'w-64'} fixed left-0 top-0 h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white z-50 transition-all duration-300`}>
